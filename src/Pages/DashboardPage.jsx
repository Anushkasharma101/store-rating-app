  ...
  return (
    <div className="w-full h-[90%] bg-[#D9D9D9] flex flex-col items-end justify-end">
      <div className="w-full h-[30%] flex flex-col items-center">
        ...
        <div className="group border border-[#474747] w-[15%] h-[22%] mt-10 rounded-full flex items-center justify-between p-2 transition duration-300 hover:bg-[#474747] cursor-pointer" onClick={()=> navigate("/stores")}>
          {/* Text */}
